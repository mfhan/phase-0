...
#-- The importance of natural language: Instead of having the method speak in a strange robot-ese, we decided to have three natural-language scripts covering the three possible outcomes of an order.
