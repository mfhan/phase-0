...
# We sought ways to avoid force-feeding the cipher, instead opting to use the rotate method to shift the order of letters. We made use of the tr method to transfor strings. We simplified the logic of the cipher, we changed variable names, and removed the hash in doing so.