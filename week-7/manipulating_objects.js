...
// Add a carson property to the value of the terah children property. carson should be an object with a propertyname with the value "Carson".

terah.children = {carson: "Carson"};

// Add a carter property to the value of the terah children property. carter should be an object with a propertyname with the value "Carter".

terah.children = {carter: "Carter"};

// Add a colton property to the value of the terah children property. colton should be an object with a propertyname with the value "Colton".
